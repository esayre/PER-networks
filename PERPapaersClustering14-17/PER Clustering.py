...
titles = open('C:/Users/Waika Wong/PycharmProjects/untitled11/text_titles').read().split('\n')

print(str(len(titles)) + ' titles')

synopses_imdb = open('C:/Users/Waika Wong/PycharmProjects/untitled11/text_samples').read().split('\n\nBREAKS HERE\n')
...
"(document index (ith-row), term number(jth-column)) tfidf score"
